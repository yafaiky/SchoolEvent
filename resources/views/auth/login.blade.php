...
<head>
    ...
    <title>Login &mdash; SchoolEvent</title>
    ...
    <style>
        ...
        body::before {
            ...
            position: fixed;
            inset: 0;
            background: radial-gradient(ellipse at 20% 50%, rgba(79,70,229,0.15) 0%, transparent 55%),
        ...
        .back-home a:hover { color: #818cf8; }
    </style>
</head>
<body>
    <div class="auth-card">
        ...
        <p class="auth-subtitle">Masuk ke akun Anda untuk mengelola acara.</p>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <label class="d-flex align-items-center gap-2 cursor-pointer" style="color:#94a3b8; font-size:0.85rem;">
                    <input type="checkbox" name="remember" class="checkbox-custom" id="remember_me">
